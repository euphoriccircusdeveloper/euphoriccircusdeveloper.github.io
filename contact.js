...
//tier 1
async function contentGetter_contact_us() {
	console.log("contact us running!!!!!!!!!!!!!!!!!")
	var gallery_images_dir_from_root = "CLICK-HERE/contact-us.txt";
    
    // Fetch the content of the file
    const response = await fetch(gallery_images_dir_from_root);
    ...
    for (let line of lines) {
        constructed_html += `<div class="page-intro">${line.trim()}</div>\n`;
    }
