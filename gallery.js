...
async function contentGetter_gallery_images() {
	...
	var gallery_images_dir_from_root="global/images/page-images/gallery-images/"
...
async function get_files_list_2(){
		...
		const response = await fetch('https://api.github.com/repos/L-Holmes/L-Holmes.github.io/contents/global/images/page-images/gallery-images');
...
async function contentGetter_gallery_images() {
	...
	var gallery_images_dir="global/images/page-images/gallery-images/"
	...
	for(int i = 0; i < len(gallery_files_list); i+=2){
		...
		if(numImages==1){
			var base_string = `
			<div class="grid-container">
				<img class="full-width-img" src="global/images/page-images/gallery-images/${file1}" alt="">
			  </template>
			</div>
			`
		}
			...
			var base_string = `
			<div class="grid-container">
				<img class="half-width-img" src="global/images/page-images/gallery-images/${file1}" alt="">
				<img class="half-width-img" src="global/images/page-images/gallery-images/${file2}" alt="">
			  </template>
			</div>
			`
